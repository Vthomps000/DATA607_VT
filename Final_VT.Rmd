...
Based on the graphs and tables above there does appear to be some relationship between the population and the number of worlwide COVID-19 cases. However, this is observational. Due to several other factors, including pre-existing health conditions we cannot confirm this hypothesis.
